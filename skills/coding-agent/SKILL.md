...
**⚠️ CRITICAL: Never review PRs in OpenShell's own project folder!**
...
8. **NEVER start Codex inside your OpenShell state directory** (`$OPENSHELL_STATE_DIR`, default `~/.openshell`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/openshell/** - that's the LIVE OpenShell instance!
...
For long-running background tasks, append a wake trigger to your prompt so OpenShell gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
openshell system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: openshell system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
